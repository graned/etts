...
class ETTSDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        text = self._load_transcript(entry["transcript"])
        audio_path = entry["audio"]

        # Convert transcript to list of phoneme indices
        phoneme_ids = self.phoneme_dict.encode_text(text)
        ...
        # Generate mel spectrogram from the same audio
